...
|------|-------------|-------|-------------------------|--------|---------|
|`execution_inclusion_list_transactions_received_total`| Counter | Total number of received inclusion list transactions | On receiving payload | | |
...
|`execution_inclusion_list_transaction_validation_time_seconds`| Histogram |  Time taken to validate inclusion list transaction | On inclusion list transactions validation | | |
